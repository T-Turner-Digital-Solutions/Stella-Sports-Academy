  ...
  return (
    <>
      <PageHero
        ...
        title="News & Updates"
        description="Athlete achievements, program announcements, partnerships, and more from Stella Sports Academy."
      />
        ...
        <Container>
          {newsPosts.length > 0 ? (
            ...
            <EmptyState
              ...
              description="Program announcements and athlete achievements will appear here as Stella shares them."
            />
          )}
        </Container>
      </section>
