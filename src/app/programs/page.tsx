  ...
  return (
    <>
      <PageHero
        ...
        title="Our Programs"
        description="Stella supports young athletes across four connected areas — because success on the field depends on support everywhere else, too."
      />
