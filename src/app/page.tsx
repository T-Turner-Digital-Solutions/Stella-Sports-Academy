      ...
      <section className="bg-white py-20 sm:py-28">
        <Container>
          <div className="mx-auto max-w-3xl text-center">
            <SectionHeading eyebrow="Our Mission" title="Why Stella Exists" align="center" />
      ...
      <section className="relative overflow-hidden bg-ink py-20 sm:py-28">
        ...
        <Container className="relative">
          <SectionHeading
            ...
            description="These figures update as Stella confirms new milestones — we'd rather show real progress than invented numbers."
            align="center"
            light
            className="mx-auto"
          />
        ...
        <Container className="grid gap-14 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 text-base leading-relaxed text-ink/70">
              Stella Sports Academy exists to help close that gap — connecting young athletes with
          ...
          <div className="mt-12">
            {successStories.length > 0 ? (
              ...
              <EmptyState
                ...
                description="As athletes, parents, and coaches share their Stella journey, their stories will appear here — reviewed and approved by our team."
              />
            )}
          </div>
        </Container>
        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <SectionHeading
              ...
              title="Join the Stella Community"
