  ...
  return (
    <>
      <PageHero
        ...
        title="Sponsor an Athlete"
        description="Your sponsorship gives a young athlete direct access to training, academics, and mentorship — the full Stella experience."
      />
        ...
        <Container className="grid gap-14 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-sm leading-relaxed text-ink/55">
              Stella never publishes private information about the young athletes it serves.
