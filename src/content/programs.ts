...
export const programs: Program[] = [
  {
    ...
    icon: Dumbbell,
    heroDescription:
      "Stella athletes train with a focus on fundamentals, physical development, and injury prevention — building the athletic foundation that carries into every sport and every stage of competition.",
    offerings: [
  ...
  },
  {
    ...
    icon: GraduationCap,
    heroDescription:
      "Athletic success and academic success go hand in hand. Stella keeps athletes accountable in the classroom while preparing them for the next step — college, career, and beyond.",
    offerings: [
  ...
  },
  {
    ...
    icon: Compass,
    heroDescription:
      "Sports are the platform — life is the goal. Stella builds the character, decision-making, and resilience young athletes carry with them long after their playing days.",
    offerings: [
  ...
  },
  {
    ...
    icon: Handshake,
    heroDescription:
      "Every athlete benefits from someone in their corner. Stella connects young athletes with mentors who guide, encourage, and open doors — on the field and off.",
    offerings: [
      "Coaches",
      "Trainers",
      "Former athletes",
