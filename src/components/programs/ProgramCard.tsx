...
export function ProgramCard({ program }: { program: Program }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col gap-5 rounded-2xl border border-ink/10 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-maroon-700/30 hover:shadow-lg"
    >
      <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-maroon-100 transition-colors group-hover:bg-maroon-700">
        <Icon className="h-7 w-7 text-maroon-700 transition-colors group-hover:text-white" strokeWidth={1.75} />
      </div>
      <div>
